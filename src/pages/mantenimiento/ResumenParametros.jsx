import '../../css/page/mantenimiento/resumenParametros.css';
...
const filtrarLista = async () => {
  ...
  return (
    ...
    <div className="herramientas">
        <form className="newResumenParametrosForm" onSubmit={filtrarLista}>
        <div className="newResumenParametrosItem">
        <label>Equipo</label>
      ...
      <div className="tableTitleContainer">
        <h1 className="tableTitle">ResumenParametros</h1>
