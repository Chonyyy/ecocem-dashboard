import '../../css/page/mantenimiento/venta.css';
...
function Venta() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('http://localhost:5103/api/Venta'); // Update with your .NET API endpoint
  ...
  const columns = [
    { field: "ventaId", headerName: "ID", width: 90 },
    {
      field: "tipoEId",
